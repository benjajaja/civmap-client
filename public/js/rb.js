...
xhr.onload = (e) => {
  ...
  var biomes = _.uniq(_.flatten(_.values(config.biome_aliases))).filter((biome) => ['ICE_MOUNTAINS', 'TAIGA_HILLS', 'FOREST_HILLS', 'SMALL_MOUNTAINS', 'DESERT_HILLS', 'JUNGLE_HILLS', 'MUSHROOM_SHORE', 'FROZEN_OCEAN', 'SKY'].indexOf(biome) === -1);
  biomes.push('SKY');
